    ...
    var win    = $( this );
    var width  = wz.tool.desktopWidth() - 500;
    var height = wz.tool.desktopHeight() - 150;
    var left   = ( wz.tool.environmentWidth() / 2 ) - ( width / 2 );
    var top    = ( wz.tool.environmentHeight() / 2 ) - ( height / 2 ) + 90;
    ...
    var windowObject = wz.popup( 'https://google.com/', width, height, left, top ).render();
